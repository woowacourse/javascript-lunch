...
[🔗 배포 주소](https://shinjungoh.github.io/javascript-lunch)
...
- [x] 음식점 목록에서 음식점을 클릭하면 누르면 모달 창이 뜬다.
- [x] 모달 배경을 누르면 모달 창이 닫힌다.
- [x] 카테고리, 이름, 거리, 설명, 참고 링크를 확인할 수 있다.

### 3. 자주 가는 음식점 추가하기

- [x] 음식점 목록에서 별 아이콘을 클릭하면 자주 가는 음식점을 추가할 수 있다.
- [x] 음식점 상세 정보 모달에서 자주 가는 음식점을 추가할 수 있다.
- [x] 자주 가는 음식점 탭에서 추가한 음식점 목록을 확인할 수 있다.
- [x] 자주 가는 음식점으로 등록된 식당의 별 아이콘을 누르면 자주 가는 음식점 목록에서 제외된다.
