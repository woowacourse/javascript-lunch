...
- [x] 음식점 목록은 카테고리로 필터링 할 수 있다.
- [x] 이름/거리 순으로 정렬된다.
- [x] 음식점 목록의 음식점을 클릭하여 모달 창을 띄우면 해당 음식점의 상세 정보를 확인할 수 있다.
  - [x] 삭제하기 버튼 클릭 시 음식점이 삭제된다.
...
- [x] 카테고리 선택 시 올바르게 필터링된다.
- [x] 이름/거리순으로 올바르게 정렬된다.
- [x] LunchInfoCard 클릭 시 상세 정보가 포함된 모달이 열린다.
- [x] 삭제하기 클릭 시 음식점이 삭제된다.
