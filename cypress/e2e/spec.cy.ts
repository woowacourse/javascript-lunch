...
describe('애플리케이션 테스트 케이스', () => {
  ...
  describe('음식점 상세 정보를 확인할 수 있다.', () => {
    beforeEach(() => {
      cy.get('[data-id="6"][data-action="restaurant-detail"]').click();
    });
  ...
  describe('자주 가는 음식점을 추가하고 목록으로 확인할 수 있다.', () => {
    it('음식점 목록에서 자주 가는 음식점을 추가할 수 있다.', () => {
      cy.get('[data-id="6"][data-action="restaurant-detail"] [data-action="restaurant-like"]').click();
