...
const Rest4 = new Restaurant('이태리키친', '캠퍼스부터 20분 내', '늘 변화를 추구하는 이태리키친입니다.', '양식');
const Rest5 = new Restaurant('호아빈 삼성점', '캠퍼스부터 15분 내', '푸짐한 양에 국물이 일품인 쌀국수', '아시안');
const Rest6 = new Restaurant('도스타코스 선릉점', '캠퍼스부터 5분 내', '멕시칸 캐주얼 그릴', '기타');

export const RestaurantList = [Rest1, Rest2, Rest3, Rest4, Rest5, Rest6];
