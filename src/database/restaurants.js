export const restaurants = [
  ...
  {
    src: "./icons/category-chinese.png",
    alt: "중식",
    name: "친친",
    distance: "캠퍼스부터 5분 내",
    description:
  ...
  {
    src: "./icons/category-japanese.png",
    alt: "일식",
    name: "잇쇼우",
    distance: "캠퍼스부터 10분 내",
    description:
  ...
  {
    src: "./icons/category-western.png",
    alt: "양식",
    name: "이태리키친",
