  ...
  const restaurants = [
    {
      ...
      description: `평양 출신의 할머니가 수십 년간 운영해온 비지 전문점 피양콩 할마니. 두부를 빼지 않은 되비지를 맛볼 수 있는
            ...
            먹을 수 있게 준비돼 있다.`,
      icon: RestaurantIcon({ src: './category-korean.png', alt: '한식' }),
    },
    {
      name: '친친',
      distance: 5,
      description: 'Since 2004 편리한 교통과 주차, 그리고 관록만큼 깊은 맛과 정성으로 정통 중식의 세계를 펼쳐갑니다',
      icon: RestaurantIcon({ src: './category-chinese.png', alt: '중식' }),
    },
    {
      name: '잇쇼우',
      distance: 10,
      ...
      icon: RestaurantIcon({ src: './category-japanese.png', alt: '일식' }),
    },
    {
      name: '이태리키친',
      distance: 20,
      description: '늘 변화를 추구하는 이태리키친입니다.',
      icon: RestaurantIcon({ src: './category-western.png', alt: '양식' }),
    },
    {
      name: '호아빈 삼성점',
      distance: 15,
      description: '푸짐한 양에 국물이 일품인 쌀국수',
      icon: RestaurantIcon({ src: './category-asian.png', alt: '아시안' }),
    },
    {
      name: '도스타코스 선릉점',
      distance: 5,
      description: '멕시칸 캐주얼 그릴',
      icon: RestaurantIcon({ src: './category-etc.png', alt: '기타' }),
    },
  ];

  // 변환된 데이터를 기반으로 리스트 추가
